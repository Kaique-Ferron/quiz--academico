...
(286, 'Recursos de orientação em smartphones utilizam principalmente:', 30, 17),
(287, 'O acesso a mapas em aplicativos geralmente depende de:', 30, 17),
(288, 'A distribuição de aplicativos mobile normalmente ocorre por meio de:', 30, 17),
...
(304, 'Qual é o objetivo do teste de software?', 10, 24),
(305, 'O que significa legibilidade no código?', 10, 24),
(306, 'O que é reutilização de código?', 10, 24),
(307, 'A indentação no código serve para:', 10, 24),
(308, 'O que é UX (Experiência do Usuário)?', 10, 24),
(309, 'O que são testes funcionais?', 20, 24),
(310, 'Testes automatizados são executados:', 20, 24),
(311, 'O teste de usabilidade avalia:', 20, 24),
(312, 'O desenvolvimento orientado por testes (TDD) consiste em:', 20, 24),
(313, 'A programação em par acontece quando:', 20, 24),
(314, 'O objetivo da refatoração é:', 30, 24),
(315, 'Testes de integração verificam:', 30, 24),
(316, 'Testes não funcionais analisam aspectos como:', 30, 24),
(317, 'O modelo CMMI está relacionado com:', 30, 24),
(318, 'A validação em testes de software busca garantir que:', 30, 24);
